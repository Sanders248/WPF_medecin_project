...
namespace Medical_tp.ServiceUser {
    ...
    public interface IServiceUser {
        ...
        Medical_tp.ServiceUser.User[] GetListUser();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetListUser", ReplyAction="http://tempuri.org/IServiceUser/GetListUserResponse")]
        System.Threading.Tasks.Task<Medical_tp.ServiceUser.User[]> GetListUserAsync();
        ...
        Medical_tp.ServiceUser.User GetUser(string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetUser", ReplyAction="http://tempuri.org/IServiceUser/GetUserResponse")]
        System.Threading.Tasks.Task<Medical_tp.ServiceUser.User> GetUserAsync(string login);
        ...
        bool AddUser(Medical_tp.ServiceUser.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/AddUser", ReplyAction="http://tempuri.org/IServiceUser/AddUserResponse")]
        System.Threading.Tasks.Task<bool> AddUserAsync(Medical_tp.ServiceUser.User user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceUserChannel : Medical_tp.ServiceUser.IServiceUser, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceUserClient : System.ServiceModel.ClientBase<Medical_tp.ServiceUser.IServiceUser>, Medical_tp.ServiceUser.IServiceUser {
        ...
        public Medical_tp.ServiceUser.User[] GetListUser() {
            return base.Channel.GetListUser();
        }
        
        public System.Threading.Tasks.Task<Medical_tp.ServiceUser.User[]> GetListUserAsync() {
            return base.Channel.GetListUserAsync();
        }
        
        public Medical_tp.ServiceUser.User GetUser(string login) {
            return base.Channel.GetUser(login);
        }
        
        public System.Threading.Tasks.Task<Medical_tp.ServiceUser.User> GetUserAsync(string login) {
            return base.Channel.GetUserAsync(login);
        }
        
        public bool AddUser(Medical_tp.ServiceUser.User user) {
            return base.Channel.AddUser(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddUserAsync(Medical_tp.ServiceUser.User user) {
